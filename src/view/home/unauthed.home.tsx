  ...
  return (
    <PageLayout>
      ...
      >
              ...
              <div className="card">
                <div className="front">
                  <div className="relative h-screen overflow-hidden w-screen  bg-cyan-500  shadow-lg ">
                    ...
                    <div className="relative pt-10 px-10 flex items-center flex-col  justify-center">
                      ...
                      />
                      <h1 className="text-2xl font-semibold capitalize m-3">
                        {section.title}
                      </h1>
                ...
                <div className="back">
                  <div className="area h-screen">
                    ...
                    <p className="text-xl leading-10 font-medium m-3 p-3 text-center">
                      {' '}
                      {section.back}
                    </p>
                  </div>
        ...
        <Link href="/">
          <button
            className=" h-12 fixed bottom-0 z-10 right-0  flex justify-end px-6 text-lg py-2.5 rounded bg-blue-500/70 text-white font-semibold "
            type="button"
          >
            Get Started
          </button>
